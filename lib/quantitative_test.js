...
test('float [not]equals', t => {
  const float1 = new Float(2);
  const float2 = new Float(2);
  const float3 = new Float(3);

  t.true(float1.equals(float2));
  t.false(float1.equals(float3));

  t.false(float1.notEquals(float2));
  t.true(float1.notEquals(float3));
});
...
test('int [not]equals', t => {
  const int1 = new Int(2);
  const int2 = new Int(2);
  const int3 = new Int(3);

  t.true(int1.equals(int2));
  t.false(int1.equals(int3));

  t.false(int1.notEquals(int2));
  t.true(int1.notEquals(int3));
});
